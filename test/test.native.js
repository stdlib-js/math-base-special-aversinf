...
tape( 'the function computes the inverse versed sine', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the inverse versed sine (small positive numbers)', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
